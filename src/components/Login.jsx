    ...
    <main className="authPage">
      ...
      <style>{`
        .authPage {
          ...
          padding: 48px 20px;
          background:
            radial-gradient(ellipse 800px 500px at 70% 10%, rgba(255,107,74,0.07) 0%, transparent 65%),
            radial-gradient(ellipse 600px 400px at 20% 80%, rgba(19,184,200,0.05) 0%, transparent 60%),
            #0a0e1a;
        }
